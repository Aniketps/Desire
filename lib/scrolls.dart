                        ...
                        builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
                          ...
                          return Column(
                            children: scrolls.map((scroll) {
                              ...
                              if (data == null) return const SizedBox.shrink(); // Skip if data is null
                              ...
                              return Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(width: 2, color: const Color(0x664300fb)),
                                ),
                                child: Padding(
                                              ...
                                              ...Tasknames.map((task) {
                                                return Column(
                                                  children: [
                                                    ...
                                                    const Divider(color: Color(0x664300fb)),
                                                  ],
                                                );
                                              }),
                                            ],
